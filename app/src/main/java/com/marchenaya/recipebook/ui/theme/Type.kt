...
import com.marchenaya.recipebook.R
...
val josefinFont = GoogleFont("Josefin Sans")

val tenorFont = GoogleFont("Tenor Sans")
...
val tenorFontFamily = FontFamily(
    Font(googleFont = tenorFont, fontProvider = provider)
)
